...
class __$$PendingImplCopyWithImpl<$Res>
    extends _$UserStateCopyWithImpl<$Res, _$PendingImpl>
...
abstract class _Pending implements UserState {
...
class __$$SetImplCopyWithImpl<$Res>
    extends _$UserStateCopyWithImpl<$Res, _$SetImpl>
...
class _$SetImpl implements _Set {
  ...
  @override
  String toString() {
    return 'UserState.set(user: $user)';
  }
...
abstract class _Set implements UserState {
  const factory _Set(final User user) = _$SetImpl;
